/*
 * arch/arm/mach-tegra/board-chagall-pinmux.c
 *
...
static __initdata struct tegra_drive_pingroup_config chagall_drive_pinmux[] = {
	...
	/* SDMMC1 */
	SET_DRIVE(SDIO1,	DISABLE, DISABLE, DIV_8, 5, 5, FAST, FAST),
...
static __initdata struct tegra_drive_pingroup_config chagall_pvt_drive_pinmux[] = {
	/* LCD2 I2C */
	SET_DRIVE(LCD2,         DISABLE, ENABLE, DIV_4, 20, 20, FASTEST, FASTEST),
};
...
static __initdata struct tegra_pingroup_config chagall_pinmux_common[] = {
	/* SDMMC1 pinmux */
	...
	DEFAULT_PINMUX(GPIO_PV1,        RSVD,             NORMAL,    NORMAL,     INPUT), /* AP_ACOK */
	...
	DEFAULT_PINMUX(SPI2_MOSI,       SPI6,            NORMAL,    NORMAL,     OUTPUT),
...
static __initdata struct tegra_pingroup_config chagall_pinmux_chagall[] = {
        DEFAULT_PINMUX(PEX_L0_PRSNT_N,  PCIE,            NORMAL,    NORMAL,     INPUT),
        DEFAULT_PINMUX(PEX_L0_CLKREQ_N, PCIE,            NORMAL,    NORMAL,     INPUT),
...
static void __init chagall_pinmux_audio_init(void)
{
...
static void __init chagall_gpio_init_configure(void)
{
	int len;
	int i;
...
int __init chagall_pinmux_init(void)
{
	chagall_gpio_init_configure();

	tegra_pinmux_config_table(chagall_pinmux_common, ARRAY_SIZE(chagall_pinmux_common));
	tegra_drive_pinmux_config_table(chagall_drive_pinmux,
			ARRAY_SIZE(chagall_drive_pinmux));

	tegra_drive_pinmux_config_table(chagall_pvt_drive_pinmux,
			ARRAY_SIZE(chagall_pvt_drive_pinmux));

	tegra_pinmux_config_table(chagall_pinmux_chagall,
		ARRAY_SIZE(chagall_pinmux_chagall));

	tegra_pinmux_config_table(unused_pins_lowpower,
		ARRAY_SIZE(unused_pins_lowpower));

	chagall_pinmux_audio_init();
...
struct gpio_init_pin_info pin_lpm_chagall_common[] = {
        PIN_GPIO_LPM("uu SPI1_CS0_N",   TEGRA_GPIO_PX6, 1, 0),
        PIN_GPIO_LPM("uu SPI1_MOSI",    TEGRA_GPIO_PX4, 1, 0),
        PIN_GPIO_LPM("uu SPI2_CS0_N",   TEGRA_GPIO_PX3, 1, 0),
        PIN_GPIO_LPM("uu SPI2_SCK",     TEGRA_GPIO_PX2, 1, 0),

        PIN_GPIO_LPM("uu ULPI_DATA2",   TEGRA_GPIO_PO3, 1, 0),
        PIN_GPIO_LPM("uu ULPI_NXT",     TEGRA_GPIO_PY2, 1, 0),
        PIN_GPIO_LPM("uu ULPI_STP",     TEGRA_GPIO_PY3, 1, 0),

        PIN_GPIO_LPM("uu GPIO_PCC2",    TEGRA_GPIO_PCC2, 1, 0),

        PIN_GPIO_LPM("uu GMI_AD11",     TEGRA_GPIO_PH3, 1, 0),
        PIN_GPIO_LPM("uu GMI_AD13",     TEGRA_GPIO_PH5, 1, 0),
        PIN_GPIO_LPM("uu GMI_AD15",     TEGRA_GPIO_PH7, 1, 0),
        PIN_GPIO_LPM("uu GMI_CS0",      TEGRA_GPIO_PJ0, 1, 0),
        PIN_GPIO_LPM("uu GMI_CS1",      TEGRA_GPIO_PJ2, 1, 0),
        PIN_GPIO_LPM("uu GMI_CS2",      TEGRA_GPIO_PK3, 1, 0),
        PIN_GPIO_LPM("uu GMI_CS3",      TEGRA_GPIO_PK4, 1, 0),
        PIN_GPIO_LPM("uu GMI_CS4",      TEGRA_GPIO_PK2, 1, 0),
        PIN_GPIO_LPM("uu GMI_CS6",      TEGRA_GPIO_PI3, 1, 0),
        PIN_GPIO_LPM("uu GMI_CS7",      TEGRA_GPIO_PI6, 1, 0),
        PIN_GPIO_LPM("uu GMI_DQS",      TEGRA_GPIO_PI2, 1, 0),
        PIN_GPIO_LPM("uu GMI_RST_N",    TEGRA_GPIO_PI4, 1, 0),
        PIN_GPIO_LPM("uu GMI_WAIT",     TEGRA_GPIO_PI7, 1, 0),

        PIN_GPIO_LPM("uu LCD_CS0_N",    TEGRA_GPIO_PN4, 1, 0),
        PIN_GPIO_LPM("uu LCD_SCK",      TEGRA_GPIO_PZ4, 1, 0),
        PIN_GPIO_LPM("uu LCD_SDOUT",    TEGRA_GPIO_PN5, 1, 0),

        PIN_GPIO_LPM("uu KB_COL4",      TEGRA_GPIO_PQ4, 1, 0),
        PIN_GPIO_LPM("uu KB_COL5",      TEGRA_GPIO_PQ5, 1, 0),
        PIN_GPIO_LPM("uu KB_COL6",      TEGRA_GPIO_PQ6, 1, 0),
        PIN_GPIO_LPM("uu KB_COL7",      TEGRA_GPIO_PQ7, 1, 0),
        PIN_GPIO_LPM("uu KB_ROW10",     TEGRA_GPIO_PS2, 1, 0),
        PIN_GPIO_LPM("uu KB_ROW13",     TEGRA_GPIO_PS5, 1, 0),
        PIN_GPIO_LPM("uu KB_ROW14",     TEGRA_GPIO_PS6, 1, 0),
        PIN_GPIO_LPM("uu KB_ROW5",      TEGRA_GPIO_PR5, 1, 0),
        PIN_GPIO_LPM("uu KB_ROW8",      TEGRA_GPIO_PS0, 1, 0),
        PIN_GPIO_LPM("uu KB_ROW9",      TEGRA_GPIO_PS1, 1, 0),
        PIN_GPIO_LPM("uu SYS_CLK_REQ",  TEGRA_GPIO_PZ5, 1, 0),

        PIN_GPIO_LPM("uu CLK3_OUT",     TEGRA_GPIO_PEE0, 1, 0),
        PIN_GPIO_LPM("uu CLK3_REQ",     TEGRA_GPIO_PEE1, 1, 0),

        PIN_GPIO_LPM("uu SDMMC3_DAT5",  TEGRA_GPIO_PD0, 1, 0),
        PIN_GPIO_LPM("uu GMI_A16",      TEGRA_GPIO_PJ7, 1, 0),
};

struct gpio_init_pin_info pin_lpm_chagall_r104[] = {
        PIN_GPIO_LPM("uu GPIO_PV2",     TEGRA_GPIO_PV2,  1, 0),
        PIN_GPIO_LPM("uu GPIO_PV3",     TEGRA_GPIO_PV3,  1, 0),
        PIN_GPIO_LPM("uu CLK2_OUT",     TEGRA_GPIO_PW5,  1, 0),
        PIN_GPIO_LPM("uu CLK2_REQ",     TEGRA_GPIO_PCC5, 1, 0),
};
 ...
 * recomendation */
int __init chagall_pins_state_init(void)
{

	set_unused_pin_gpio(&pin_lpm_chagall_common[0],
		ARRAY_SIZE(pin_lpm_chagall_common));

	set_unused_pin_gpio(&pin_lpm_chagall_r104[0],
		ARRAY_SIZE(pin_lpm_chagall_r104));
